...
def load_augs(cfg: DictConfig) -> A.Compose:
    ...
    # print('augs_cfg', cfg)
    # print('augs', augs)
    # TODO rewrite this. bbox parameters shouldn't be fixed
    return A.Compose(augs, p=1.0, bbox_params=A.BboxParams(format='yolo'), keypoint_params=None, additional_targets={})
